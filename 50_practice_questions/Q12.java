...
and decided to divide the berry, however they faced a hard problem. Pete and Billy are great fans of even numbers, 
...
Input Format 
The first (and the only) input line contains integer number w — the 
...
Explanation 0 
For example, the boys can divide the watermelon into two parts of 2 
and 6 kilos respectively (another variant — two parts of 4 and 4 
kilos). 
